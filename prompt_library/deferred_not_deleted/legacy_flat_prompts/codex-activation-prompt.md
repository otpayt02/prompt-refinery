...
This single message hard-resets Codex's default "helpful assistant" loop. It removes the implicit behavior that causes agents to ask questions, rewrite your prompts, or generate verbose output. It establishes the boundary: **Perplexity thinks, Codex builds**.
